...
<body>
    <form id="form1" runat="server">
        <div class="auto-style1">
            ...
            <div class="links">
                <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/user sign.aspx">Back</asp:HyperLink>
                <asp:Button ID="Button3" runat="server" Height="53px" Text="Home" CssClass="btn" OnClick="Button3_Click" />
            </div>
        </div>
    </form>
</body>
